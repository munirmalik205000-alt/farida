      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <Card className="border border-slate-200 hover:shadow-lg hover:-translate-y-1 transition-all">
            ...
            <CardContent>
              <p className="text-3xl font-bold text-slate-900" data-testid="total-income">
          ...
          <Card className="border border-slate-200 hover:shadow-lg hover:-translate-y-1 transition-all">
            ...
            <CardContent>
              <p className="text-3xl font-bold text-slate-900" data-testid="today-income">
          ...
          <Card className="border border-slate-200 hover:shadow-lg hover:-translate-y-1 transition-all">
            ...
            <CardContent>
              <p className="text-3xl font-bold text-slate-900" data-testid="repurchase-income">
